...
<head>
    ...
    <title>Dashboard | iREX Admin</title>
                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                         src="dist/assets/images/undraw_posting_photo.svg" alt="...">
                                </div>
...
<script src="{{ asset('dist/assets/js/demo/chart-area-demo.js') }}"></script>
<script src="{{ asset('dist/assets/js/demo/chart-pie-demo.js') }}"></script>
