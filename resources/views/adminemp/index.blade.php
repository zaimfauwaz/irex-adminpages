                                ...
                                <div class="col-12">
                                    <div id="accordion">
                                        <div class="card shadow mb-4">
                                            <a class="card-header py-3" href="#" data-bs-toggle="collapse" data-bs-target="#collapseUser{{$emp->employee_id}}" data-bs-parent="#accordion" role="button" aria-expanded="false">
                                            ...
                                            <div id="collapseUser{{$emp->employee_id}}" class="collapse">
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex justify-content-end">
                                                        <a href="{{ route('adminemp.show', $emp->employee_id) }}" class="btn btn-sm btn-info mx-1">
                                                            <i class="bi bi-view-list"></i> View</a>
                                                        <a href="{{ route('adminemp.edit', $emp->employee_id) }}" class="btn btn-sm btn-warning mx-2">
                                                            <i class="bi bi-pencil"></i> Edit</a>
                                                        <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal-{{ $emp->employee_id }}">
...
@foreach ($employees as $emp)
    @include('components.deletemodal', ['emp'=> $emp])
@endforeach
