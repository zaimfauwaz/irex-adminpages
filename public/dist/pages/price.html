...
<head>
  <title>Pricing | Mantis Bootstrap 5 Admin Template</title>
  <!-- [Meta] -->
  <meta charset="utf-8">
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="card price-card">
            <div class="card-body">
              ...
              <div class="price-price my-4">129 <span class="text-muted"> Lifetime</span></div>
              <div class="d-grid"><a class="btn btn-primary mb-4" href="#" role="button">Order
                  Now</a></div>
              <ul class="list-group list-group-flush product-list">
                <li class="list-group-item enable">One End Product</li>
                <li class="list-group-item enable">No attribution required</li>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="card price-card">
            <div class="card-body">
              <div class="price-icon">
                <img src="../assets/images/pages/img-price-extended.svg" alt="img" class="img-fluid">
